...
directory "#{home}/.config/sublime-text-3/Installed\ Packages" do
	action :create
end
execute "#{home}/.config/sublime-text-3/Installed\ Packages/Package\ Control.sublime-package" do
	command "wget -q -O - https://packagecontrol.io/Package%20Control.sublime-package > '#{home}/.config/sublime-text-3/Installed\ Packages/Package\ Control.sublime-package'"
end
